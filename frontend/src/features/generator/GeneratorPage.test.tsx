...
const OPTIONS = {
  sizes: [
    { value: "1024x1024" as const, label: "Square", aspect: "1024 / 1024" },
    { value: "1024x1536" as const, label: "Portrait", aspect: "1024 / 1536" },
    { value: "1536x1024" as const, label: "Landscape", aspect: "1536 / 1024" },
  ],
  qualities: [
    { value: "standard" as const, label: "Standard" },
    { value: "hd" as const, label: "High detail" },
  ],
...
describe("prompt guide", () => {
  ...
  it("can fill the prompt with the worked example", async () => {
    ...
    const field = screen.getByLabelText(/describe your image/i) as HTMLTextAreaElement;
